            ...
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                <div class="container">
                    <a class="navbar-brand" href="{{ route('front.index') }}">
                        <img src="{{asset('assets/frontend/images/logo.png')}}" alt="logo" style="max-width: 220px; max-height: 130px;" title="NamsExpress">
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " id="merchantPanel" href="{{ route('staff') }}#merchant-panel">Merchant Panel</a>
                            </li>
                            <li class="nav-item">

...
class SettingsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('general_settings')->insert([
            'title' => 'NamsExpress',
            'header_title' => 'NamsExpress',
            'header_subtitle' => 'NamsExpress is a Branch based courier management system. Courier or Parcel Sender will send from a branch. Receiver will receive from destination branch set on sending !',
            ...
            'footer_text' => '© '.$copyright.' - Copyright All rights reserved.',
            ...
            'created_at' => '2022-02-21 10:23:05',
            'updated_at'=> '2022-02-21 10:23:05',
        ]);

        DB::table('units')->insert(['name' => 'KG', 'status' => 'Active']);
        DB::table('units')->insert(['name' => 'LBS', 'status' => 'Active']);

        DB::table('courier_types')->insert(['unit_id' => 2, 'price' => 10, 'name' => 'Regular', 'status' => 'Active']);
        DB::table('courier_types')->insert(['unit_id' => 2, 'price' => 20, 'name' => 'Express', 'status' => 'Active']);
    }
}
